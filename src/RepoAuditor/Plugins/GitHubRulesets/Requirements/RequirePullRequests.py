...
# |
# -------------------------------------------------------------------------------
"""Contains the RequirePullRequests object for the GitHubRulesets plugin."""
...
class RequirePullRequests(Requirement):
    """Require pull requests before merging to branch."""

    def __init__(self) -> None:
        super().__init__(
            name="RequirePullRequests",
            description="Require pull requests before merging to branch",
